...
type Lead={id:string;first_name:string;last_name:string;phone_number:string;instagram_handle:string;source:string;status:string;health_goals:string;pain_points:string;ai_score:number;last_contacted_at:string;next_follow_up_at:string;created_at:string;updated_at:string};
